...
public class MiniGame extends JFrame {
    ...
    private void addImageBackground() {
        TextureLoader t = new TextureLoader("models/grass.jpg", canvas);
    ...
    private TransformGroup getRoadGroup() throws IOException {
    	Shape3D shape = getModelShape3D("road", "models/road/road.obj");
    	addAppearance(shape, "models/road/road.jpg");
    	
    	Transform3D transform3D = new Transform3D();
    	transform3D.setScale(new Vector3d(7, 7, 7));
